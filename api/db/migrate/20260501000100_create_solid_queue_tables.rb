class CreateSolidQueueTables < ActiveRecord::Migration[8.1]
  def up
    ...
    add_solid_queue_foreign_key :solid_queue_blocked_executions
    add_solid_queue_foreign_key :solid_queue_claimed_executions
    add_solid_queue_foreign_key :solid_queue_failed_executions
    add_solid_queue_foreign_key :solid_queue_ready_executions
    add_solid_queue_foreign_key :solid_queue_recurring_executions
    add_solid_queue_foreign_key :solid_queue_scheduled_executions
  end

  def down
    remove_solid_queue_foreign_key :solid_queue_scheduled_executions
    remove_solid_queue_foreign_key :solid_queue_recurring_executions
    remove_solid_queue_foreign_key :solid_queue_ready_executions
    remove_solid_queue_foreign_key :solid_queue_failed_executions
    remove_solid_queue_foreign_key :solid_queue_claimed_executions
    remove_solid_queue_foreign_key :solid_queue_blocked_executions
  ...
  def add_solid_queue_foreign_key(table_name)
    return if foreign_key_exists?(table_name, :solid_queue_jobs, column: :job_id)

    add_foreign_key table_name, :solid_queue_jobs, column: :job_id, on_delete: :cascade
  end

  def remove_solid_queue_foreign_key(table_name)
    return unless foreign_key_exists?(table_name, :solid_queue_jobs, column: :job_id)

    remove_foreign_key table_name, column: :job_id
  end
end
