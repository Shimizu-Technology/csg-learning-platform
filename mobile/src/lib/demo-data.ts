...
export const demoMessages: Record<string, Message[]> = {
  'channel:12': [
    { id: 101, channel_id: 12, direct_conversation_id: null, parent_message_id: null, body: 'Before tomorrow, push your latest branch and add one question to the help channel.', mention_user_ids: [], edited_at: null, deleted_at: null, pinned_at: ago(400), created_at: ago(420), updated_at: ago(420), mine: true, reactions: [{ emoji: '✅', count: 3, reacted: false, users: [{ id: 18, full_name: 'Maya Santos', avatar_url: null }, { id: 23, full_name: 'Noah Cruz', avatar_url: null }, { id: 29, full_name: 'Kai Perez', avatar_url: null }] }], attachments: [], author: demoUser },
    ...
    { id: 104, channel_id: 12, direct_conversation_id: null, parent_message_id: null, body: formattedDemoMessage, mention_user_ids: [], edited_at: null, deleted_at: null, pinned_at: null, created_at: ago(8), updated_at: ago(8), mine: true, reactions: [], attachments: [], read_receipts: { count: 8, users: [] }, author: demoUser },
  ],
  'channel:13': [],
  'channel:14': [],
  'dm:31': [
