...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: palette.muted, fontFamily: fonts.bold, fontSize: 11, letterSpacing: 1.8 },
  ...
  accessPillText: { color: '#76D7AA', fontFamily: fonts.bold, fontSize: 11, letterSpacing: 0.25 },
  ...
  dividerText: { color: palette.subtle, fontFamily: fonts.bold, fontSize: 11, letterSpacing: 1.3 },
  ...
  footerText: { color: palette.subtle, fontFamily: fonts.medium, fontSize: 11 },
});
