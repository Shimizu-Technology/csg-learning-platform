...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: palette.rubySoft, fontFamily: fonts.bold, fontSize: 11, letterSpacing: 1.7 },
  ...
  accountLabel: { color: palette.subtle, fontFamily: fonts.bold, fontSize: 11, letterSpacing: 1.3 },
  ...
  note: { color: palette.subtle, fontFamily: fonts.medium, fontSize: 11, lineHeight: 17, textAlign: 'center', marginTop: 18 },
