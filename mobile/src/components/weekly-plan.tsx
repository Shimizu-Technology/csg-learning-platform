...
function LibraryPlan({ plan }: { plan: WeeklyPlan }) {
  ...
  return <View style={styles.shell}>
    ...
    <View style={styles.libraryStats}><LibraryStat value={library.module_count} label="Modules" /><LibraryStat value={library.lesson_count} label="Lessons" /><LibraryStat value={library.recording_count} label="Recordings" /></View>
