import { Archive, ArrowRight, BookOpen, ChevronDown, ChevronUp, CircleDot, Search } from 'lucide-react-native';
...
export function StaffCurriculumDetailView({ curriculum, filter, onFilterChange, onOpenLesson }: { curriculum: StaffCurriculum; filter: string; onFilterChange: (value: string) => void; onOpenLesson: (id: number) => void }) {
